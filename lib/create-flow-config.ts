...
export const CREATE_FLOW_COPY: Record<SubjectTypeId, CreateFlowCopy> = {
  pet: {
    ...
    nameHint: "Optional – we’ll use it to personalize your portrait.",
  ...
  couple: {
    ...
    subhead: ‘Turn your couple photo into a romantic Renaissance or Victorian double portrait. Free preview • One price for everything.’,
  ...
  family: {
    ...
    subhead: ‘Transform your family photo into a stunning Renaissance or Victorian group portrait. Perfect for gifts • Free preview included.’,
